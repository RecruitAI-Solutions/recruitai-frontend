...
export default function CandidateDashboard() {
  ...
  return (
    // ═══ PAGE USES CONTAINER FOR RESPONSIVE WIDTH ═══
    <Container className="py-8">
      ...
      {/* Stats Grid - Auto responsive with Container */}
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <button className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            ...
            <div>
              <p className="font-medium text-gray-900">Upload CV</p>
